...
exports.sendRegistrationEmail = exports.sendBoardingPass = void 0;
const qrcode_1 = __importDefault(require("qrcode"));
const config_1 = require("../../../config");
const sendBoardingPass = async (userEmail, userClg, eventName) => {
    const qr = await qrcode_1.default.toDataURL(userEmail);
    const data = {
...
const sendRegistrationEmail = async (name, email, paperTitle) => {
